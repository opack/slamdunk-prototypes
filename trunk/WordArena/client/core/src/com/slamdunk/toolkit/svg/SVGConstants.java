...
public interface SVGConstants {
	...
	public static final String ATTRIBUTE_STROKE_MITER_LIMIT		 = "stroke-miterlimit";

	public static final String TAG_IGNORED_SODIPODI		 		 = "sodipodi";
	public static final String TAG_IGNORED_INKSCAPE		 		 = "inkscape";
