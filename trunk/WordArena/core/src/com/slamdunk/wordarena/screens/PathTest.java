...
//	boolean zigzag = false;
	...
	public PathTest() {
		...
		obj.setSize(40, 40);
		obj.setOriginCenter();
//		obj2 = new Sprite(new Texture(Gdx.files.internal("textures/dbg_warrior.png")));
//		obj2.setSize(40, 40);
...
//		Vector2 cp[] = new Vector2[] { new Vector2(0, 0),
//				new Vector2(w * 0.25f, h * 0.5f), new Vector2(0, h),
//				new Vector2(w * 0.5f, h * 0.75f), new Vector2(w, h),
//				new Vector2(w * 0.75f, h * 0.5f), new Vector2(w, 0),
...
//		obj2.draw(spriteBatch);
	...
	private void touch(int x, int y) {
		t = paths.get(currentPath).locate(
