...
public class GameScreenOld extends SlamScreen {
	...
	public GameScreenOld(SlamGame game) {
		super(game);
...
//DBG		enemyAI = new BasicAI(this, enemyPaths);
	}
	...
	public void tileTouched(Point tilePosition) {
		...
		if (spawnUnit != null) {
			...
			if (bestPath != null) {
//DBG				objectsOverlay.spawnUnit(spawnUnit, bestPath);
			}
		}
	}
